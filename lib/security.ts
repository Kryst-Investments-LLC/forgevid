...
export class SecurityAuditLogger {
  ...
  static async logSuspiciousActivity(ip: string, activity: string, details: any = {}) {
  ...
  static async logDataAccess(userId: string, resource: string, action: string) {
...
// Request validation
export function validateRequest(request: NextRequest): { isValid: boolean; reason?: string } {
...
export function securityMiddleware(request: NextRequest): { allowed: boolean; response?: NextResponse } {
