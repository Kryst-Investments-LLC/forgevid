...
import { Play, Sparkles, Users, Zap, Globe, Shield, Star, CheckCircle, ArrowRight, Clock, TrendingUp, } from "lucide-react";
import { PricingCard } from "@/components/pricing-card";
import Link from "next/link";
import ClientDarkModeToggle from "@/components/ClientDarkModeToggle";
function LanguageSwitcher() {
    return (<div style={{ position: 'fixed', top: 60, right: 16, zIndex: 1000 }}>
    ...
    return (<div className="min-h-screen bg-background">
      ...
      <section id="pricing" className="container py-24">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
          {/* Free Plan */}
          <PricingCard title="Free" price="$0" description="Perfect for getting started" features={[
            "12 video minutes/week",
            "2 AI credits/week",
            "5 exports/week (with watermark)",
            "Basic templates",
            "Community support",
        ]} buttonText="Get Started" buttonVariant="outline"/>

          <PricingCard title="Plus" price="$25/mo" description="Best for content creators" features={[
            ...
            "Stock media access",
            "Email support",
        ]} planId="plus" buttonText="Start Free Trial"/>

          <PricingCard title="Max" price="$45/mo" description="Best for professionals" features={[
            ...
            "Priority support",
        ]} planId="max" popular={true} buttonText="Start Free Trial"/>

          <PricingCard title="Generative" price="$90/mo" description="Best for advanced creators" features={[
            "220 video minutes/month",
            ...
            "Advanced analytics",
            "Priority support",
        ]} planId="generative" buttonText="Start Free Trial"/>

          <PricingCard title="Team" price="$850/mo" description="Best for teams & agencies" features={[
            ...
            "SLA support",
        ]} planId="team" buttonText="Contact Sales" buttonVariant="outline"/>
        </div>
