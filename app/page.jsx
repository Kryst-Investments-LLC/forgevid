      ...
      <div className="relative z-10 min-h-screen flex flex-col items-center justify-center px-4">
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            <a href="/en" className="group relative px-8 py-4 bg-gradient-to-r from-cyan-500 to-blue-600 text-white rounded-xl font-semibold text-lg hover-lift glow-cyan transition-all duration-300 shadow-xl hover:shadow-cyan-500/50">
            ...
            <a href="/dashboard" className="group px-8 py-4 glass-card text-white rounded-xl font-semibold text-lg hover-lift border border-purple-500/30 hover:border-purple-400/60 transition-all duration-300">
          ...
          <div className="mt-16 max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[1, 2, 3, 4, 5, 6].map((i) => (<div key={i} className="glass-card rounded-xl overflow-hidden hover-lift">
          ...
          <div className="mt-12 flex items-center justify-center gap-2 text-sm text-gray-500">
            ...
            <span className="mx-2">•</span>
            <button onClick={(e) => { e.preventDefault(); const btn = document.querySelector('[data-cookie-preferences-trigger]'); btn?.click(); }} className="underline text-cyan-400 hover:text-cyan-300" data-testid="manage-cookies-link">Manage Cookies</button>
          </div>
        </div>
      </div>
    </div>);
