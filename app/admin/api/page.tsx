            ...
            <CardContent className="space-y-6">
              <div className="flex items-center justify-between">
                ...
                <Switch
                  ...
                  checked={rateLimitConfig.globalEnabled}
                  onCheckedChange={(checked) => setRateLimitConfig((prev) => ({ ...prev, globalEnabled: checked }))}
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    id="default-limit"
                    type="number"
                    value={rateLimitConfig.defaultLimit}
                    onChange={(e) =>
                      setRateLimitConfig((prev) => ({ ...prev, defaultLimit: Number.parseInt(e.target.value) }))
                    }
                  />
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      setRateLimitConfig((prev) => ({ ...prev, burstLimit: Number.parseInt(e.target.value) }))
                    }
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  {[
                    ...
                    <div key={tier.tier} className={`p-4 rounded-lg ${tier.color}`}>
