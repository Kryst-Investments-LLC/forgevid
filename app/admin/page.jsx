...
import { Users, Video, TrendingUp, DollarSign, Search, MoreHorizontal, Shield, Ban, CheckCircle, AlertTriangle, Calendar, Download, CreditCard, Target, ArrowUpRight, ArrowDownRight, } from "lucide-react";
...
export default function AdminDashboard() {
    ...
    return (<div className="min-h-screen bg-background p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <Tabs defaultValue="revenue" className="space-y-6">
          ...
          <TabsContent value="revenue" className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {revenueStats.map((stat) => (<Card key={stat.title}>
                  <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                    <CardTitle className="text-sm font-medium">{stat.title}</CardTitle>
            ...
            <div className="grid lg:grid-cols-2 gap-6">
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  {subscriptionBreakdown.map((plan) => (<div key={plan.plan} className="space-y-2">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="grid grid-cols-6 gap-2">
                      {monthlyRevenueData.map((month, index) => (<div key={month.month} className="text-center">
                          <div className="space-y-2">
                            <div className="h-20 bg-muted rounded flex items-end justify-center p-1">
                              <div className="bg-primary rounded-t w-full" style={{ height: `${(month.revenue / 100000) * 100}%` }}/>
                            </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-4">
                    <div className="relative">
                      ...
                      <Input placeholder="Search users..." className="pl-10 w-64" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}/>
                    </div>
                  </div>
                </div>
              </CardHeader>
          ...
          <TabsContent value="system" className="space-y-6">
            <div className="grid md:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent className="space-y-4">
                  {systemAlerts.map((alert) => (<div key={alert.id} className="flex items-start gap-3 p-3 border rounded-lg">
        ...
        ].map((service) => (<div key={service.name} className="flex items-center justify-between p-3 border rounded-lg">
                      <div className="flex items-center gap-3">
                        <div className={`w-2 h-2 rounded-full ${service.status === "healthy"
                ? "bg-green-500"
