...
import { Activity, AlertTriangle, Clock, Cpu, Globe, HardDrive, MemoryStick, Server, TrendingUp, Users, } from "lucide-react";
export default function MonitoringDashboard() {
    ...
    return (<div className="space-y-6">
      ...
      {/* Active Alerts */}
      {alerts.filter((alert) => alert.status === "active").length > 0 && (<Alert>
              ...
              <CardContent>
                <ResponsiveContainer width="100%" height={400}>
                  <AreaChart data={performanceData}>
                    ...
                    <YAxis />
                    <Tooltip />
                    <Area type="monotone" dataKey="responseTime" stroke="hsl(var(--primary))" fill="hsl(var(--primary))" fillOpacity={0.3}/>
                  </AreaChart>
                </ResponsiveContainer>
              </CardContent>
            </Card>
              ...
              <Table>
                ...
                <TableBody>
                  {services.map((service, index) => (<TableRow key={index}>
                      ...
                      <TableCell>
                        <Badge variant={service.status === "healthy"
                ? "default"
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {errorLogs.map((log) => (<TableRow key={log.id}>
          ...
          <Card>
            ...
            <CardContent>
              <Table>
                ...
                <TableBody>
                  {alerts.map((alert) => (<TableRow key={alert.id}>
                      <TableCell>
                        <Badge variant={alert.severity === "high"
                ? "destructive"
                : alert.severity === "medium"
                    ...
                    : "outline"}>
                      ...
                      <TableCell>
                        <Badge variant={alert.status === "active"
                ? "destructive"
                    ...
                    : "default"}>
                      ...
                      <TableCell>
                        <div className="flex space-x-2">
                          {alert.status === "active" && (<Button variant="outline" size="sm">
                              Acknowledge
                            </Button>)}
                          <Button variant="outline" size="sm">
                            Resolve
