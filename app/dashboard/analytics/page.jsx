    ...
    return (<div className="min-h-[600px]">
          ...
          <Tabs defaultValue="usage" className="space-y-6">
            ...
            <TabsContent value="usage" className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      {usageData.videoMinutes.limit !== -1 && (<Progress value={usageData.videoMinutes.percentage} className="h-2"/>)}
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      {usageData.exports.limit !== -1 && (<Progress value={usageData.exports.percentage} className="h-2"/>)}
                      <p className="text-xs text-muted-foreground">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      {usageData.collaborators.limit !== -1 && (<Progress value={usageData.collaborators.percentage} className="h-2"/>)}
                      <p className="text-xs text-muted-foreground">
              ...
              {/* Usage Warnings */}
              {Object.values(usageData).some((usage) => usage.percentage > 80) && (<Card className="border-orange-200 bg-orange-50">
                  <CardHeader>
                  ...
                  <CardContent>
                    <div className="space-y-2">
                      {usageData.videoMinutes.percentage > 80 && (<p className="text-sm text-orange-700">
                          You've used {usageData.videoMinutes.percentage}% of your video minutes this month.
                        </p>)}
                      {usageData.exports.percentage > 80 && (<p className="text-sm text-orange-700">
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="grid grid-cols-6 gap-4">
                      {monthlyStats.map((month, index) => (<div key={month.month} className="text-center">
                          <div className="space-y-2">
                            <div className="h-20 bg-muted rounded flex items-end justify-center p-2">
                              <div className="bg-primary rounded-t w-full" style={{ height: `${(month.videos / 40) * 100}%` }}/>
                            </div>
            ...
            <TabsContent value="performance" className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {topTemplates.map((template, index) => (<div key={template.name} className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                          ...
                          <div className="w-20 bg-muted rounded-full h-2">
                            <div className="bg-primary h-2 rounded-full" style={{ width: `${(template.uses / 50) * 100}%` }}/>
                          </div>
                        </div>
                      </div>))}
                  </div>
