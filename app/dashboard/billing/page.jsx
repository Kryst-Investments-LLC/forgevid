      ...
      <div className="grid gap-6 md:grid-cols-2">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            {subscription.cancelAtPeriodEnd && (<div className="flex items-center gap-2 p-3 bg-orange-50 border border-orange-200 rounded-lg">
            ...
            <div className="space-y-2">
              <Button variant="outline" className="w-full bg-transparent" onClick={handleUpdatePaymentMethod} disabled={loading}>
                <CreditCard className="mr-2 h-4 w-4"/>
                Update Payment Method
              </Button>

              {!subscription.cancelAtPeriodEnd && (<Button variant="outline" className="w-full text-red-600 hover:text-red-700 bg-transparent" onClick={handleCancelSubscription} disabled={loading}>
            ...
            {invoices.map((invoice) => (<div key={invoice.id} className="flex items-center justify-between p-4 border rounded-lg">
                <div className="flex items-center gap-4">
                  <div className="flex items-center justify-center w-10 h-10 bg-secondary rounded-full">
                    {invoice.status === "paid" ? (<CheckCircle className="h-5 w-5 text-green-600"/>) : (<Clock className="h-5 w-5 text-orange-600"/>)}
                  </div>
                  <div>
