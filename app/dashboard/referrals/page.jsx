...
import { Users, Gift, Copy, Share2, TrendingUp, DollarSign, CheckCircle, Mail, Twitter, Facebook, Linkedin, } from "lucide-react";
          ...
          <Tabs defaultValue="overview" className="space-y-6">
            ...
            <TabsContent value="referrals" className="space-y-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {recentReferrals.map((referral) => (<div key={referral.id} className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-4">
                        ...
                        <div className="text-right">
                          <div className="flex items-center gap-2 mb-1">
                            <Badge variant={referral.status === "active"
                ? "default"
              ...
              <Card>
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
                    {rewardTiers.map((tier, index) => (<Card key={tier.name} className={`${tier.name === referralStats.tier ? "ring-2 ring-primary" : ""}`}>
                        <CardContent className="p-4 text-center">
                          ...
                          {tier.name === referralStats.tier && (<Badge variant="outline" className="mt-2">
                              Current Tier
                            </Badge>)}
                        </CardContent>
                      </Card>))}
