...
import { Code, Key, Play, Copy, CheckCircle, AlertCircle, Zap, Globe, Shield, Clock, DollarSign, Book, Terminal, } from "lucide-react";
              ...
              <Card className="lg:col-span-1">
                ...
                <CardContent>
                  <div className="space-y-2">
                    {endpoints.map((endpoint) => (<div key={endpoint.id} className={`p-3 rounded-lg cursor-pointer transition-colors ${selectedEndpoint === endpoint.id ? "bg-primary/10 border border-primary/20" : "hover:bg-muted"}`} onClick={() => setSelectedEndpoint(endpoint.id)}>
                        <div className="flex items-center gap-2 mb-1">
                          <Badge variant={endpoint.method === "GET"
                ? "default"
              ...
              <Card className="lg:col-span-2">
                <CardHeader>
                  <CardTitle className="flex items-center gap-2">
                    <Badge variant={endpoints.find((e) => e.id === selectedEndpoint)?.method === "GET"
            ? "default"
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Input value={apiKey} onChange={(e) => setApiKey(e.target.value)} placeholder="Enter your API key" type="password"/>
                    </div>

                    <div>
                      <label className="block text-sm font-medium mb-2">Endpoint</label>
                      <select value={selectedEndpoint} onChange={(e) => setSelectedEndpoint(e.target.value)} className="w-full p-2 border rounded-md">
                        {endpoints.map((endpoint) => (<option key={endpoint.id} value={endpoint.id}>
                    ...
                    <div>
                      ...
                      <Textarea value={requestBody} onChange={(e) => setRequestBody(e.target.value)} rows={8} className="font-mono text-sm"/>
                    </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="flex gap-2 mb-3">
                        {Object.keys(codeExamples).map((lang) => (<Button key={lang} variant={selectedLanguage === lang ? "default" : "outline"} size="sm" onClick={() => setSelectedLanguage(lang)}>
                    ...
                    <div className="relative">
                      ...
                      <Button size="sm" variant="outline" className="absolute top-2 right-2 bg-transparent" onClick={() => handleCopy(codeExamples[selectedLanguage])}>
