...
export default function VideoCard({
  ...
  return (
    <motion.div
      whileHover={{ scale: 1.02, boxShadow: "0 20px 40px rgba(0,0,0,0.6)" }}
      className="bg-gradient-to-b from-white/3 to-white/2 glass-card rounded-2xl overflow-hidden border border-white/6"
    >
      <div
