      ...
      <div>
        ...
        <FeatureGate feature="aiFeatures" plan="starter">
          <Card>
            ...
            <CardContent className="space-y-4">
              <Textarea placeholder="Describe your video idea... e.g., 'Create a product ad for eco-friendly shoes with upbeat music and modern transitions'" value={prompt} onChange={(e) => setPrompt(e.target.value)} className="min-h-[100px]"/>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <FeatureGate feature="aiFeatures" plan="starter" fallback={<Button variant="outline" size="sm" className="w-full justify-start bg-transparent" disabled>
            ...
            <FeatureGate feature="aiFeatures" plan="pro" fallback={<Button variant="outline" size="sm" className="w-full justify-start bg-transparent" disabled>
        ...
        ].map((item, index) => (<div key={index} className="flex items-center justify-between p-2 rounded border">
                <div>
