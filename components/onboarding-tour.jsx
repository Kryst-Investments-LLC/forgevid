...
const tourSteps = [
    ...
    },
    {
        ...
        description: "Click here to start creating your first AI-powered video. You can use templates or start from scratch.",
          ...
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-center gap-2">
              <div className="w-8 h-8 bg-primary/10 rounded-full flex items-center justify-center">
                {currentStep === 0 || currentStep === tourSteps.length - 1 ? (<Lightbulb className="h-4 w-4 text-primary"/>) : (<Target className="h-4 w-4 text-primary"/>)}
              </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center pt-2">
              <div className="flex gap-2">
                {currentStep > 0 && (<Button variant="outline" size="sm" onClick={handlePrevious}>
              ...
              <Button size="sm" onClick={handleNext}>
                {currentStep === tourSteps.length - 1 ? ("Get Started") : (<>
