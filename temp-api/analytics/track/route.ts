...
async function processReferralEvent(event: any) {
...
async function processConversionEvent(event: any) {
...
async function creditReferrer(referralCode: string, referredUserId: string, type: string, amount?: number) {
...
function calculateCommission(subscriptionValue: number, referralCode: string): number {
...
async function trackConversionAttribution(data: any) {
