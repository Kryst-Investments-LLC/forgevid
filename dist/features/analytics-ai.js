...
export async function getEngagementMetrics(videoId, period = '30d') {
    try {
...
export async function getAudienceInsights(videoId, period = '30d') {
    try {
...
export async function generateAIInsights(videoId, engagement, audience, performance) {
    try {
        const prompt = `
...
export async function generateAnalyticsReport(videoId, period = '30d') {
    try {
