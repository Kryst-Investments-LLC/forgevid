...
export default function MetricCard({ title, value, delta, icon, }) {
    return (<div className="glass-card p-6 rounded-2xl shadow-xl border border-cyan-500/20 hover:border-cyan-400/40 flex flex-col h-full overflow-hidden hover-lift transition-all duration-300 group">
      ...
      {delta && (<div className="flex items-center gap-1 mt-4">
