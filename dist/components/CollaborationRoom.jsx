...
import { Users, MessageSquare, Edit3, Play, Pause, Volume2, Send, Sparkles } from "lucide-react";
export function CollaborationRoom({ roomId, user, onError }) {
    ...
    const sendVideoStateChange = useCallback((state) => {
        if (socket && isConnected) {
    ...
    return (<div className="h-screen flex flex-col bg-background">
      ...
      <div className="flex-1 flex">
        ...
        <div className="flex-1 flex flex-col">
            ...
            <Card className="h-full">
              ...
              <CardContent className="h-full">
                <div className="h-full bg-muted/50 rounded-lg flex items-center justify-center relative">
                  ...
                  {/* Cursors */}
                  {cursors.map((cursor) => (<div key={cursor.userId} className="absolute w-4 h-4 pointer-events-none" style={{
                left: `${cursor.x}%`,
                top: `${cursor.y}%`,
            }}>
          ...
          {/* AI Suggestion */}
          {aiSuggestion && (<div className="mx-4 mb-4">
          ...
          <div className="border-t p-4">
            <div className="flex items-center space-x-2 mb-4">
              ...
              {typingUsers.length > 0 && (<span className="text-sm text-muted-foreground">
            ...
            <ScrollArea className="h-32 mb-4">
              <div className="space-y-2">
                {messages.map((message) => (<div key={message.id} className="flex items-start space-x-2">
        ...
        <div className="w-80 border-l p-4 space-y-4">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-2">
                {roomUsers.map((roomUser) => (<div key={roomUser.id} className="flex items-center space-x-2">
                    ...
                    {roomUser.id === user.id && (<Badge variant="secondary" className="text-xs">You</Badge>)}
                  </div>))}
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              <ScrollArea className="h-32">
                <div className="space-y-2">
                  {edits.slice(-5).map((edit) => (<div key={edit.id} className="text-xs">
