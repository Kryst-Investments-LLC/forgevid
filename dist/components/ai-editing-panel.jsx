...
import { Scissors, Palette, Type, Volume2, Wand2, Play, Download, Loader2, Eye } from 'lucide-react';
...
function AIEditingPanel() {
    ...
    const applyEdit = async (editType, parameters) => {
        if (!videoUrl) {
            toast.error('Please enter a video URL');
            return;
        }
    ...
    return (<div className="space-y-6" style={{ minHeight: '600px', contain: 'layout' }}>
      <Card>
        <CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="flex gap-2">
              <Input id="videoUrl" value={videoUrl} onChange={(e) => setVideoUrl(e.target.value)} placeholder="https://example.com/video.mp4" className="flex-1"/>
          ...
          {analysis && (<Card>
              ...
              <CardContent>
                ...
                {analysis.scenes.length > 0 && (<div className="mt-4">
                    <h4 className="font-medium mb-2">Detected Scenes:</h4>
                    <div className="space-y-1">
                      {analysis.scenes.map((scene, index) => (<div key={index} className="text-sm text-muted-foreground">
          ...
          <Tabs defaultValue="auto" className="w-full">
            ...
            <TabsContent value="auto" className="space-y-4">
              <div className="space-y-2">
                ...
                <Textarea id="autoPrompt" value={autoEditPrompt} onChange={(e) => setAutoEditPrompt(e.target.value)} placeholder="e.g., Make this video more engaging by adding transitions and text overlays, trim the boring parts..." rows={3}/>
                <Button onClick={generateSuggestions} disabled={isProcessing || !videoUrl || !autoEditPrompt} className="w-full">
              ...
              {suggestions.length > 0 && (<div className="space-y-2">
                  ...
                  {suggestions.map((suggestion, index) => (<Card key={index} className="p-4">
                      <div className="flex items-start justify-between">
                        ...
                        <Button size="sm" onClick={() => applySuggestion(suggestion)} disabled={isProcessing}>
                          Apply
                        </Button>
                      </div>
                    </Card>))}
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input type="number" value={editParams.startTime} onChange={(e) => setEditParams(prev => ({
            ...prev,
            startTime: parseInt(e.target.value) || 0
                    ...
                    <div className="space-y-2">
                      ...
                      <Input type="number" value={editParams.endTime} onChange={(e) => setEditParams(prev => ({
            ...prev,
            endTime: parseInt(e.target.value) || 30
        }))}/>
                    </div>
                    <Button onClick={() => applyEdit('trim', {
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Select value={editParams.filterType} onValueChange={(value) => setEditParams(prev => ({
            ...prev,
            filterType: value
        }))}>
                        <SelectTrigger>
                    ...
                    <Button onClick={() => applyEdit('filter', {
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input value={editParams.textContent} onChange={(e) => setEditParams(prev => ({
            ...prev,
            textContent: e.target.value
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      <div className="space-y-1">
                        ...
                        <Input type="number" value={editParams.textPosition.x} onChange={(e) => setEditParams(prev => ({
            ...prev,
            textPosition: { ...prev.textPosition, x: parseInt(e.target.value) || 0 }
                      ...
                      <div className="space-y-1">
                        ...
                        <Input type="number" value={editParams.textPosition.y} onChange={(e) => setEditParams(prev => ({
            ...prev,
            textPosition: { ...prev.textPosition, y: parseInt(e.target.value) || 0 }
        }))}/>
                      </div>
                    </div>
                    <Button onClick={() => applyEdit('text_overlay', {
            textContent: editParams.textContent,
            textPosition: editParams.textPosition,
            textStyle: editParams.textStyle
        })} disabled={isProcessing || !editParams.textContent} className="w-full">
                      Add Text
                    </Button>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <div className="flex items-center space-x-2">
                        <input type="checkbox" id="noiseReduction" checked={editParams.audioEnhancement.noiseReduction} onChange={(e) => setEditParams(prev => ({
            ...prev,
            audioEnhancement: {
                ...
                noiseReduction: e.target.checked
                      ...
                      <div className="flex items-center space-x-2">
                        <input type="checkbox" id="volumeBoost" checked={editParams.audioEnhancement.volumeBoost} onChange={(e) => setEditParams(prev => ({
            ...prev,
            audioEnhancement: {
                ...prev.audioEnhancement,
                volumeBoost: e.target.checked
                    ...
                    <Button onClick={() => applyEdit('audio_enhance', {
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <Select value={editParams.outputFormat} onValueChange={(value) => setEditParams(prev => ({
            ...prev,
            outputFormat: value
        }))}>
                ...
                <div className="space-y-2">
                  <Label>Quality</Label>
                  <Select value={editParams.quality} onValueChange={(value) => setEditParams(prev => ({
            ...prev,
            quality: value
        }))}>
