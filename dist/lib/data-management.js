export class BackupManager {
    ...
    static simulateBackupProgress(backupId) {
        let progress = 0;
    ...
    static async restoreBackup(backupId, options) {
...
export class RetentionManager {
    ...
    static async runCleanup(policyId) {
    ...
    static async scheduleCleanup(policyId, schedule) {
