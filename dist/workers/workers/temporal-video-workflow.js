...
exports.videoGenerationWorkflow = videoGenerationWorkflow;
exports.startVideoGenerationWorkflow = startVideoGenerationWorkflow;
var client_1 = require("@temporalio/client");
// Define workflow interface (to be implemented in Temporal worker)
function videoGenerationWorkflow(_a) {
    return __awaiter(this, arguments, void 0, function (_b) {
        var prompt = _b.prompt, style = _b.style, duration = _b.duration, addOns = _b.addOns;
        return __generator(this, function (_c) {
            ...
            return [2 /*return*/, { videoUrl: 'https://example.com/generated.mp4', cost: 1.25 }];
        });
    });
}
// Client code to start a workflow
function startVideoGenerationWorkflow(params) {
    return __awaiter(this, void 0, void 0, function () {
        var connection, client, handle;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client_1.Connection.connect()];
                case 1:
                    connection = _a.sent();
                    client = new client_1.Client({ connection: connection });
                    return [4 /*yield*/, client.workflow.start(videoGenerationWorkflow, {
                            taskQueue: 'video-generation',
                            workflowId: "video-gen-".concat(Date.now()),
                            args: [params],
                        })];
                case 2:
                    handle = _a.sent();
