              ...
              <Table>
                ...
                <TableBody>
                  {filteredUsers.map((user) => (<TableRow key={user.id}>
                      ...
                      <TableCell>
                        <Badge variant={user.status === "active"
                ? "default"
                : user.status === "suspended"
                    ...
                    : "secondary"}>
                      ...
                      <TableCell>
                        {user.mfaEnabled ? (<Badge variant="default">
              ...
              <Table>
                ...
                <TableBody>
                  {organizations.map((org) => (<TableRow key={org.id}>
                      ...
                      <TableCell>
                        {org.ssoEnabled ? (<Badge variant="default">{org.ssoProvider}</Badge>) : (<Badge variant="outline">Disabled</Badge>)}
                      </TableCell>
                      <TableCell>
                        <Button variant="outline" size="sm">
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              <div className="grid gap-4 md:grid-cols-2">
                <Card>
                  <CardHeader>
                    <CardTitle className="text-lg">SAML 2.0</CardTitle>
                    <CardDescription>Enterprise SAML integration</CardDescription>
                  </CardHeader>
                  <CardContent>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>OAuth provider integration</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Button variant="outline" className="w-full bg-transparent">
                      Configure OAuth
                ...
                <Card>
                  <CardHeader>
                    ...
                    <CardDescription>Okta identity provider</CardDescription>
                  </CardHeader>
                  <CardContent>
                    <Button variant="outline" className="w-full bg-transparent">
                      Configure Okta
