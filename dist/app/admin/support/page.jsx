...
import { MessageCircle, Clock, User, AlertCircle, CheckCircle, TrendingUp, Search, Filter, MoreHorizontal, } from "lucide-react";
export default function AdminSupportPage() {
    ...
    return (<div className="space-y-6">
      ...
      <Tabs defaultValue="tickets" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {tickets.map((ticket) => (<div key={ticket.id} className="border rounded-lg p-4 hover:bg-gray-50 transition-colors">
        ...
        ].map((member, index) => (<div key={index} className="flex items-center justify-between p-4 border rounded-lg">
