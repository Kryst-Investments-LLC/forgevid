...
import { Play, CheckCircle, Star, Image as ImageIcon, Globe, Users, Heart, Eye, Wand2 } from "lucide-react";
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
            ...
            <Card className="glass-card border-gray-700 hover:border-cyan-500/50 transition-all">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  {t.raw('pricing.plans.free.features').map((feature, i) => (<li key={i} className="flex items-start gap-2">
            ...
            <Card className="glass-card border-purple-500 relative">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  {t.raw('pricing.plans.plus.features').map((feature, i) => (<li key={i} className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5"/>
                      <span>{feature}</span>
                    </li>))}
                </ul>
            ...
            <Card className="glass-card border-gray-700 hover:border-pink-500/50 transition-all">
              ...
              <CardContent>
                ...
                <ul className="space-y-2 text-sm text-gray-400">
                  {t.raw('pricing.plans.max.features').map((feature, i) => (<li key={i} className="flex items-start gap-2">
                      <CheckCircle className="h-5 w-5 text-green-400 flex-shrink-0 mt-0.5"/>
                      <span>{feature}</span>
                    </li>))}
                </ul>
        ...
        <section className="py-16 text-center">
          <div className="glass-card p-12 rounded-3xl border border-cyan-500/30">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 text-sm text-gray-400">
              {t.raw('cta.guarantees').map((guarantee, i) => (<div key={i} className="flex items-center gap-2">
