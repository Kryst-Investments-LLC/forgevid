...
export default function CollaboratePage() {
    ...
    if (roomId && user && jwtToken) {
        return (<CollaborationRoom roomId={roomId} user={user} onError={(error) => setError(error)}/>);
    }
          ...
          <Card className="w-full max-w-md mx-auto">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                <Input value={roomId} onChange={(e) => setRoomId(e.target.value)} placeholder="Enter room ID" className="w-full"/>
                <div className="flex space-x-2">
                  <Button onClick={handleJoinRoom} disabled={isJoining || !roomId.trim() || !jwtToken} className="flex-1">
                    {isJoining ? (<>
