...
export class LoadTestSuite {
     ...
     */
    createArtilleryConfig(scenario) {
        return {
            config: {
     ...
     */
    async parseArtilleryResults(configFile, scenario, startTime) {
        try {
            const fs = require('fs');
            ...
            Logger.error('Failed to parse Artillery results', error);
            throw error;
        }
    }
    /**
