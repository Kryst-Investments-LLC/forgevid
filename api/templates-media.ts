// Templates and Media Management API
...
async function handleSearchTemplates(req: NextApiRequest, res: NextApiResponse, decoded: any) {
  const filters: TemplateSearchFilters = req.body.filters || {};
...
async function handleSearchMedia(req: NextApiRequest, res: NextApiResponse, decoded: any) {
  const filters: MediaSearchFilters = req.body.filters || {};
...
async function handleGetTemplate(req: NextApiRequest, res: NextApiResponse, decoded: any) {
...
async function handleGetMedia(req: NextApiRequest, res: NextApiResponse, decoded: any) {
...
async function handleGenerateTemplate(req: NextApiRequest, res: NextApiResponse, decoded: any) {
...
async function handleUploadMedia(req: NextApiRequest, res: NextApiResponse, decoded: any) {
...
async function handlePopularTemplates(req: NextApiRequest, res: NextApiResponse, decoded: any) {
...
async function handleRecentTemplates(req: NextApiRequest, res: NextApiResponse, decoded: any) {
  const { limit = 10 } = req.body;
...
async function handleRecommendedTemplates(req: NextApiRequest, res: NextApiResponse, decoded: any) {
  const { limit = 10 } = req.body;
