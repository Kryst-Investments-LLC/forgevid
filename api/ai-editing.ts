...
async function handleAnalyzeVideo(req: NextApiRequest, res: NextApiResponse, decoded: any) {
...
async function handleGenerateSuggestions(req: NextApiRequest, res: NextApiResponse, decoded: any) {
...
async function handleApplyEdit(req: NextApiRequest, res: NextApiResponse, decoded: any) {
  const editRequest: VideoEditRequest = req.body;
...
async function handleBatchEdit(req: NextApiRequest, res: NextApiResponse, decoded: any) {
...
async function handleCreateThumbnail(req: NextApiRequest, res: NextApiResponse, decoded: any) {
